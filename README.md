...
As an example, I would be unable to host the network visualization d3graph2.html directly on my hosted website. However, I can use an iframe that includes src="https://LastCodeBender42.github.io/d3graph2.html" and now it works like a charm. See the network viz <a href="https://analysisandinformatics.org/d2graph2-html">here</a>.
